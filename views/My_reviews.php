    ...
    if (count($reviews)) {
        ...
        if ($pageCount != 1) {
            ...
            for ($i = 1; $i <= $pageCount; $i++) {
                if ($i === 1) {
                    if (isset($_GET['page'])) {
                        echo '<a href="my-reviews"><div class="page_link_div">'.$i.'</div></a>';
                    } else {
                        echo '<a href="my-reviews'.$_GET['id'].'"><div class="page_link_div active_page_link">'.$i.'</div></a>';
                    }
                } else {
                    if (isset($_GET['page']) && $_GET['page'] == $i) {
                        echo '<a href="my-reviews?page='.$i.'"><div class="page_link_div active_page_link">'.$i.'</div></a>';
                    } else {
                        echo '<a href="my-reviews?page='.$i.'"><div class="page_link_div">'.$i.'</div></a>';
                    }
                }
